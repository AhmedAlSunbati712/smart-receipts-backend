...
analyticsRouter.get("/category", verifyToken, analyticsController.getCategoryAnalytics);
analyticsRouter.get("/vendor", verifyToken, analyticsController.getVendorAnalyitcs);
